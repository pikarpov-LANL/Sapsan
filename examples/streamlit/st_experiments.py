...
def cnn3d():
    ...
    def run_experiment():
        ...
        if widget_values['backend_selection'] == 'Fake':
            tracking_backend = FakeBackend(widget_values['experiment_name'])
            
        elif widget_values['backend_selection'] == 'MLflow':
            tracking_backend = MLflowBackend(widget_values['experiment_name'], 
        ...
        #Set the experiment
        training_experiment = Train(name=widget_values['experiment_name'],
        ...
        evaluation_experiment = Evaluate3d(name=widget_values['experiment_name'],
                                           backend=tracking_backend,
