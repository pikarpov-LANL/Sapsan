...
from sapsan.utils.shapes import split_data_by_batch, combine_data
...
class TestDatasetUtils(unittest.TestCase):
    ...
    def test_cube_split(self):
        ...
        batched = split_data_by_batch(self.cube, (32,32,32), (16,16,16), 3, 3)
    ...
    def test_cube_split_and_combine(self):
        ...
        batched = split_data_by_batch(self.cube, (32,32,32), (16,16,16), 3, 3)
        restored_cube = combine_data(batched, (32,32,32), (16,16,16), 3)
